...
export default async function handler(
    ...
    try {
        ...
        const prompt = `
You are a quiz question generator. Using the provided text, generate 10 unique multiple choice quiz questions that progressively get harder like the game Who wants to be a millionare.
...
Requirements:
- Each of the 10 questions should be unique and based on the provided text
- Make sure the 10 questions are related to the text
